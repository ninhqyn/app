...
class ModalButtonFavorites extends StatefulWidget {
  const ModalButtonFavorites({super.key});

  @override
  _ModalButtonFavoritesState createState() => _ModalButtonFavoritesState();
}

class _ModalButtonFavoritesState extends State<ModalButtonFavorites> {
