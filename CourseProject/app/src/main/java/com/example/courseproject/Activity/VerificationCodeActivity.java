    ...
    private void addAction() {
        btnVerity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                apiService.verifyEmail(getIntent().getStringExtra(KEY_EMAIL),verificationCode).enqueue(new Callback<Unit>() {
                    @Override
                    public void onResponse(Call<Unit> call, Response<Unit> response) {
                        if (response.isSuccessful()) {
                            Toast.makeText(VerificationCodeActivity.this,"Đăng kí thành công",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(VerificationCodeActivity.this, LoginActivity.class);
                            startActivity(intent);
                        } else {
                            // Handle verification failure
                            Toast.makeText(VerificationCodeActivity.this,"Sai mã .Xác thực thất bại",Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onFailure(Call<Unit> call, Throwable t) {
                        Toast.makeText(VerificationCodeActivity.this,"error call api",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
